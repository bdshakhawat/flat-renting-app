...
const RentPropertyCard = ({
  ...
  return (
    // removed max-w-[400px] 
    <div className="flex-1 rounded-3xs max-w-[400px] bg-gray-white box-border  flex flex-col py-[15px] px-[13px] items-start justify-start gap-[23px]  text-left text-[14.51px] text-gray-700 font-body-regular-600 border-[1px] border-solid border-whitesmoke-100 hover:bg-gainsboro hover:cursor-pointer sm:w-[100%!important] sm:mb-5">
         <img
        //  relative h-[200px] w-[100%]flex flex-row rounded-3xsoverflow-hidden  object-cover
            className="self-stretch  relative h-[200px] w-[100%]flex flex-row rounded-3xsoverflow-hidden  object-cover  "
            alt=""
            src={imageDimensions}
          />
      ...
      <div className="self-stretch  py-0 px-2.5 items-start justify-start gap-[17px] text-[10.84px] text-gray-500">
